...
(<b>Requires </b> <span id="ranks_req_${x}">X</span>)<hr><b id="ranks_desc_${x}">No rewards available...</b><br>
			</button>
		</div>`
	}
...
(<b>Requires</b> <span id="pres_req_${x}">X</span>)<hr><b id="pres_desc_${x}">No rewards available...</b><br>
