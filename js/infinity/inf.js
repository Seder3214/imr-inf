const INF = {
    doReset() {
        ...
        if (iu15) e.push(218)
         ...
         if (player.chal.choosed < 19 && player.chal.choosed != 20)  for (let i = 0; i < player.atom.elements.length; i++) if (player.atom.elements[i] > 218) e.push(player.atom.elements[i])
